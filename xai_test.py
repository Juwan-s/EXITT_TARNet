...
from captum.attr import Saliency, InputXGradient, DeepLift, ShapleyValueSampling, GuidedBackprop, GradientShap, DeepLiftShap, IntegratedGradients
...
parser.add_argument('--top_percent', type=int, default=70)
